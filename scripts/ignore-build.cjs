...
try {
 ...
 const contentOnly=changed.every(p=>p.startsWith('content/products/')||p.startsWith('content/categories/')||p.startsWith('content/imports/')||p.startsWith('public/images/')||p==='content/settings.json');
